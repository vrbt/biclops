...
import com.github.vrbt.biclops.decoders.implementation.LongDecoderBuilder
...
class LongTest extends Specification {
    ...
    def 'decode a whole long from the buffer'() {
        ...
        def decoder = new LongDecoderBuilder().build()
    ...
    def 'decode a whole long from the buffer - little endian'() {
        given:
        def ByteBuffer buffer = ByteBuffer.wrap Longs.toByteArray(intValue)
        def decoder = new LongDecoderBuilder().byteOrder LITTLE_ENDIAN build()
    ...
    def 'decode a 4-bit part of a long from the buffer'() {
        given:
        def ByteBuffer buffer = ByteBuffer.wrap Longs.toByteArray(intValue)
        def decoder = new LongDecoderBuilder().valueLengthInBits 4 build()
    ...
    def 'decode a 60-bit part of a long from the buffer'() {
        given:
        def ByteBuffer buffer = ByteBuffer.wrap Longs.toByteArray(intValue)
        def decoder = new LongDecoderBuilder().valueLengthInBits 60 build()
    ...
    def 'decode a various length part of a long from the buffer and shift the buffer'() {
        given:
        def ByteBuffer buffer = ByteBuffer.wrap Longs.toByteArray(intValue)
        def decoder = new LongDecoderBuilder().valueLengthInBits bitsUsed build()
    ...
    @Unroll
    def 'decode a 32-bit part of a long from the buffer - little endian'() {
        given:
        def ByteBuffer buffer = ByteBuffer.wrap Longs.toByteArray(intValue)
        def decoder = new LongDecoderBuilder().byteOrder LITTLE_ENDIAN valueLengthInBits 32 build()
        ...
        where:
        intValue                                                                                  | decodedValue
        0b0001_0000_0000_0000_0000_1110_0001_0001_0011_0000_0000_0000_0000_0000_0001_0000 as long | 0b0001_0001_0000_1110_0000_0000_0001_0000 as long
        0b0010_0000_0010_0000_0110_0010_0000_0110_0000_0000_0011_0010_0000_0000_1100_0000 as long | 0b0000_0110_0110_0010_0010_0000_0010_0000 as long
        0b0100_0010_0010_0101_0000_0001_0010_0001_0010_0011_0010_1100_0110_0000_0000_0000 as long | 0b0010_0001_0000_0001_0010_0101_0100_0010 as long
        0b1000_0000_0010_0000_0011_0000_0011_0100_0110_0000_0000_0000_0000_0100_0001_0000 as long | 0b0011_0100_0011_0000_0010_0000_1000_0000 as long
        0b0011_0010_0100_0000_0001_0110_0000_0001_1100_0000_0011_0010_0000_0000_1000_0011 as long | 0b0000_0001_0001_0110_0100_0000_0011_0010 as long
        0b0110_0110_0001_0001_0010_0000_0110_0010_0110_0000_1100_0000_0110_1111_0010_0110 as long | 0b0110_0010_0010_0000_0001_0001_0110_0110 as long
        0b1001_1100_0100_1100_0100_0010_0100_0110_0010_0000_0111_0011_0000_0000_1011_0000 as long | 0b0100_0110_0100_0010_0100_1100_1001_1100 as long
    }
}